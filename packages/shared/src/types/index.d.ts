...
export type FundingStage = 'bootstrapped' | 'pre_seed' | 'seed' | 'series_a' | 'series_b' | 'series_c' | 'series_d_plus' | 'public' | 'acquired' | 'unknown';
...
export type ApplicationStatus = 'saved' | 'applied' | 'oa_received' | 'hr_screen_scheduled' | 'hr_screen_completed' | 'technical_screen_scheduled' | 'technical_screen_completed' | 'hiring_manager_scheduled' | 'hiring_manager_completed' | 'final_round_scheduled' | 'final_round_completed' | 'offer_received' | 'offer_accepted' | 'offer_declined' | 'rejected_after_oa' | 'rejected_after_hr' | 'rejected_after_technical' | 'rejected_after_hiring_manager' | 'rejected_after_final' | 'ghosted' | 'withdrawn';
...
export type OutreachStatus = 'not_contacted' | 'connected' | 'messaged' | 'replied' | 'referred' | 'interview_scheduled' | 'relationship_active' | 'inactive';
...
export declare const DEFAULT_OPPORTUNITY_WEIGHTS: OpportunityWeights;
...
export declare const DEFAULT_USER_PREFERENCES: Omit<UserPreferences, 'opportunityWeights'>;
